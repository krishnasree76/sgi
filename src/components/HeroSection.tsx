...
const LogisticsHero = () => {
  ...
  return (
    <section className="bg-gradient-to-b from-white via-slate-50 to-slate-100 py-16 md:py-0 md:min-h-screen flex items-center">
      <div className="container mx-auto px-4 grid md:grid-cols-2 gap-10 items-center">
        
        {/* 🔥 LEFT CONTENT */}
        <div>
          <h1 className="text-3xl sm:text-4xl lg:text-6xl font-bold text-slate-900 leading-tight mb-6">
            Integrated Logistics <br />
            <span className="text-red-600">Solutions</span>
          </h1>

          <p className="text-slate-600 mb-6">
            25+ Years of Expertise in Door-to-Door, Air, Ocean &
          ...
          <div className="flex gap-4 flex-wrap mb-10">
            ...
            <a
              href="#contact"
              className="px-6 py-3 border border-slate-300 text-slate-800 rounded-lg font-semibold"
            >
              Contact Us
            </a>
          </div>
          ...
          <div className="grid grid-cols-1 sm:grid-cols-3 gap-4">
            {stats.map(({ icon: Icon, label, desc }) => (
              ...
              >
                <Icon className="text-red-500 mb-2" size={22} />
